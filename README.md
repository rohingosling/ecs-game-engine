# ECS Game Engine (C++ Version)
*Version 2.1 (2018, Upgraded from C++11 to C++17)*

<p align="center">
  <img src="demo/particle_demo/resources/screen_shots/screenshot-menu-main-800.png" width="48%" alt="Particle simulator main menu">&emsp;
  <img src="demo/particle_demo/resources/screen_shots/screenshot-simulation-800.png" width="48%" alt="Particle simulation in action">
</p>
...
```
ecs/        Core ECS framework (Pure C++17 with no external dependencies)
...
Released under the [MIT License](LICENSE) — Copyright © 2011 Rohin Gosling.
